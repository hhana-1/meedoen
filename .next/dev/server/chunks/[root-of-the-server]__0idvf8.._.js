...
;
;
const JWT_SECRET = new TextEncoder().encode(process.env.JWT_SECRET || 'meedoenbalie-secret-key-change-in-production');
...
async function GET(req) {
    ...
    const jobs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobListing.findMany({
        where: {
            active: true,
            ...search ? {
                OR: [
...
async function POST(req) {
    ...
    if (!title || !description) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Missing fields'
    }, {
        status: 400
    });
    const mod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$moderation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moderateContent"])(title + ' ' + description);
    if (mod.flagged) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Content flagged: ' + mod.reason
    }, {
        status: 422
    });
    const employer = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].employerProfile.findUnique({
        where: {
            userId: session.userId
        }
    });
    if (!employer) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Profile not found'
    }, {
        status: 404
    });
    const job = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobListing.create({
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0idvf8.._.js.map