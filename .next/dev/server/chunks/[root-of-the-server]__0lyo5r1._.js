...
async function POST(req) {
    try {
        ...
        const { email, password, role, language, companyName, kvkNumber, orgType, address, phone, website, name, jobseekerPhone, vnr, dateOfBirth, nationality, docNumber, docValidUntil } = body;
        if (!email || !password || !role) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (![
            'employer',
            'jobseeker'
        ].includes(role)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Invalid role'
        }, {
            status: 400
        });
        if (role === 'employer' && !companyName) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (e.code === 'P2002') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Email already registered'
        }, {
            status: 409
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0lyo5r1._.js.map