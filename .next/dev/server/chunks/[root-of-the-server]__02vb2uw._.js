...
async function GET(req) {
    ...
    if (!toUserId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Missing toUserId'
    }, {
        status: 400
    });
    const reviews = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.findMany({
        where: {
            toUserId,
            flagged: false
        },
...
async function POST(req) {
    ...
    const mod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$moderation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moderateContent"])(comment);
    const flagged = mod.flagged;
    const review = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].review.create({
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02vb2uw._.js.map