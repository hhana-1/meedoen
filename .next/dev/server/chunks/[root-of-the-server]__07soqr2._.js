...
async function GET() {
    ...
    const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobSeekerProfile.findUnique({
        where: {
...
async function PUT(req) {
    ...
    const { name, phone, vnr, dateOfBirth, nationality, docNumber, docValidUntil, bio, age, experience, education, languages, hoursPerWeek, shifts, linkedin, instagram, twitter, facebook } = body;
    if (bio) {
        const mod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$moderation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["moderateContent"])(bio);
    ...
    const profile = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].jobSeekerProfile.upsert({
        where: {
            userId: session.userId
        },
        create: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07soqr2._.js.map